...
public class Agent {
    ...
    Agent(final String name, final String address, final int port, final int balance, final Block root, final List<Agent> agents) {
        this.name = name;
    ...
    Block createBlock(String sender, String receiver, int balance) {
        ...
        final Block block = new Block(index, previousBlock.getHash(), name,name,receiver,balance);
